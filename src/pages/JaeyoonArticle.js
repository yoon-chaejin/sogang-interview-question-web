            ...
            <Container className={classes.articleContainer} maxWidth="md">
                ...
                <Collapse in={isOpen[0]}>
                    <Container>
                        ...
                        <Typography className={classes.articleBody} variant="body1">저는 아무것도 모르는 상태에서 학부연구생으로 연구실에 던져(?)졌기 때문에 Top-Down 방식으로 공부 했습니다. 이 방법의 장점은 실력이 매우 빠르게 향상된다는 점입니다. 가장 큰 단점은 체계가 없어 중구난방이 될 가능성이 크다는 것입니다. 사람마다 스타일이 다르기 때문에 나에게 맞는 방법으로 하시면 됩니다. 어떤 방식을 선택하든지 <StrongText>프로젝트를 완성하여 주목할 만한 성과를 내는 것</StrongText>이 중요합니다. </Typography>
                    </Container>
                </Collapse>
                ...
                <Collapse in={isOpen[1]}>
                    <Container>
                        ...
                        <Collapse in={isOpen[13]}>
                            <List>
                                <OpenTabLink 
                                    ...
                                    description={'http://cs229.stanford.edu/syllabus-fall2020.html'}>
                        ...
                        <Typography className={classes.articleBody} variant="body1">cs231n을 들을 때 과제도 같이 할 수 있도록 정리했습니다. 영상과 실라부스는 2017년도 강의이지만 해당년도의 과제 파일이 다운로드가 되지 않아, 2020년도 과제 링크를 첨부했습니다. 해설은 <Link href={"https://github.com/jariasf/CS231n"} target={"_blank"}>여기</Link> 있습니다.</Typography>
                        ...
                        <Collapse in={isOpen[15]}>
                            <Grid container>
                                <Grid item xs={12} md={4} style={{display : 'flex'}}>
                                    ...
                                    <Link style={{marginRight: '5px'}} href={'https://cs230.stanford.edu/files/cs230exam_fall18.pdf'} target={'_blank'}>Questions</Link>/
                                    <Link style={{marginRight: '5px'}} href={'https://cs230.stanford.edu/files/cs230exam_fall18_soln.pdf'} target={'_blank'}>Answers</Link>
                                </Grid>
                                <Grid item xs={12} md={4} style={{display : 'flex'}}>
                                    <Typography style={{marginRight: '5px'}} variant='body1'>- Winter 2019 : </Typography>
                                    <Link style={{marginRight: '5px'}} href={'https://cs230.stanford.edu/files/cs230exam_win19.pdf'} target={'_blank'}>Questions</Link>/
                                    <Link style={{marginRight: '5px'}} href={'https://cs230.stanford.edu/files/cs230exam_win19_soln.pdf'} target={'_blank'}>Answers</Link>
                                </Grid>
                                <Grid item xs={12} md={4} style={{display : 'flex'}}>
                                    <Typography style={{marginRight: '5px'}} variant='body1'>- Fall 2019 : </Typography>
                                    <Link style={{marginRight: '5px'}} href={'https://cs230.stanford.edu/files/cs230exam_fall19.pdf'} target={'_blank'}>Questions</Link>/
                                    <Link style={{marginRight: '5px'}} href={'https://cs230.stanford.edu/files/cs230exam_fall19_soln.pdf'} target={'_blank'}>Answers</Link>
                                </Grid>
                                <Grid item xs={12} md={4} style={{display : 'flex'}}>
                                    <Typography style={{marginRight: '5px'}} variant='body1'>- Winter 2020 : </Typography>
                                    <Link style={{marginRight: '5px'}} href={'https://cs230.stanford.edu/files/cs230exam_win20.pdf'} target={'_blank'}>Questions</Link>/
                                    <Link style={{marginRight: '5px'}} href={'https://cs230.stanford.edu/files/cs230exam_win20_soln.pdf'} target={'_blank'}>Answers</Link>
                                </Grid>
                                <Grid item xs={12} md={4} style={{display : 'flex'}}>
                                    <Typography style={{marginRight: '5px'}} variant='body1'>- Fall 2020 : </Typography>
                                    <Link style={{marginRight: '5px'}} href={'https://cs230.stanford.edu/files/cs230exam_fall20.pdf'} target={'_blank'}>Questions</Link>/
                                    <Link style={{marginRight: '5px'}} href={'https://cs230.stanford.edu/files/cs230exam_fall20_soln.pdf'} target={'_blank'}>Answers</Link>
                                </Grid>
                            </Grid>
                        </Collapse>
                    </Container>
                ...
                <Collapse in={isOpen[2]}>
                    ...
                    <Container>
                        ...
                        <Collapse in={isOpen[7]}>
                            ...
                            <Typography className={classes.articleBody} variant="body1">스탠포드의 자연어처리 강의인 cs224n입니다. 자연어처리의 큰 줄기를 훑는 내용이어서 반드시 한번은 다 보시길 추천드립니다. 저는 일주일에 <StrongText>2~3 강의씩 두 달</StrongText>에 걸쳐서 들었습니다. 내용이 쉽지 않으므로 방학을 이용하여 스터디를 하시면 좋을 것 같습니다. ML/DL과 마찬가지로 수업에 딸린 과제가 있고, 과제 솔루션 링크도 첨부합니다.</Typography>
                        </Collapse>
                        ...
                        <Collapse in={isOpen[9]}>
                            <Container>
                                ...
                                <Typography className={classes.articleBody} variant='body1'>AI기술을 보고 있자면 마치 컴퓨터 인간의 언어를 이해하는 것 같지만, 사실 컴퓨터는 숫자를 처리할 뿐입니다. 우리의 역할은 인간의 언어를 숫자로 표현해서 컴퓨터가 잘 이해할 수 있도록 하는 것입니다. 철자, 단어, 문장을 컴퓨터가 이해할 수 있도록 숫자로 이루어진 벡터로 변환하는 것을 임베딩이라고 합니다. 변환된 벡터는 임베딩 벡터라고 부릅니다. 결국 언어를 임베딩 공간으로 잘 보내는 기술이 관건이라고 할 수 있습니다. 더 좋은 임베딩을 생성하는 방향으로 자연어처리 분야가 발전하고 있다고 이해하면 좋을 것 같습니다. 이 내용에 대해 읽어보면 좋을 <Link href={'https://ratsgo.github.io/natural%20language%20processing/2017/08/16/deepNLP/'} target={'_blank'}>자료</Link>를 첨부합니다. 그리고 <Link href={'https://ratsgo.github.io/natural%20language%20processing/2019/09/12/embedding/'} target={'_blank'}>한국어 임베딩</Link> 이라는 책도 잘 정리되어 있습니다. </Typography>
                                <Typography className={classes.articleBody} variant="body1">좋은 임베딩을 만든 후에는 어떻게 해야할까요. 임베딩을 가지고 컴퓨터를 학습시켜야 합니다. 자연어처리 분야는 데이터가 가변적이고 이를 처리하기 위해 RNN 구조를 사용합니다. 그리고 RNN 구조의 단점을 해결하기 위해 LSTM, GRU, attention 구조, Transformer 등 여러 모델이 등장합니다. 따라서 모델 구조를 공부할 때는 이 모델이 앞선 모델의 어떤 문제점을 해결하고자 하였는지 파악하는 것이 중요합니다. 가령 attention을 공부할 때는, RNN, LSTM seq2seq 구조에서 Encoder의 정보가 context 벡터 하나로 전달 되어 정보가 손실되는 문제를, attention 구조를 통해 encoder의 정보를 계속 참조하도록 하여 해결했다는 점을 이해해야 한다는 말씀입니다. 이러한 흐름에 대한 질문을 제가 <Link href={'https://www.sogangtree.ml/questions?tag=10'} target={'_blank'}>서강트리의 NLP 카테고리</Link>에 아주 자세하게 정리했으니 꼭 스스로 공부해보시길 바랍니다.</Typography>
                                <Typography className={classes.articleSectionTitle} variant='subtitle1'>Transformer</Typography>
                                <Typography className={classes.articleBody} variant='body1'>자연어처리 분야는 Transformer가 등장한 이전과 이후로 나뉘는 것 같습니다. 이후 등장한 대규모의 모델들은 대부분 Transformer의 encoder와 decoder를 사용하고 있습니다. 예를 들어 BERT는 encoder단을, GPT는 decoder단을 활용합니다. 그렇기 때문에 Transformer의 구조를 이해하는 것은 너무나 중요합니다. 그리고, 면접에서 1순위 단골 질문입니다. Transformer를 설명한 자료는 구글에 수도 없이 많습니다. 그 중에 대표적인 <Link href={'http://jalammar.github.io/illustrated-transformer/'} target={'_blank'}>자료</Link>를 첨부합니다. 꼼꼼하게 잘 이해하고 제가 <Link href={'https://www.sogangtree.ml/questions?tag=10'} target={'_blank'}>서강트리의 NLP 카테고리</Link>에 정리한 Transformer 질문들에 답변해보세요. 바로 답변할 수 없다면, 다시 공부해야 합니다.</Typography>
                                <Typography className={classes.articleSectionTitle} variant='subtitle1'>Transfer learning</Typography>
                                <Typography className={classes.articleBody} variant='body1'><Link href={'https://ruder.io/transfer-learning/'} target={'_blank'}>전이학습</Link>이란, 기존에 학습된 모델을 이용하여 새로운 모델을 빠르게 학습시키는 방법입니다. 인간의 학습 방법과 굉장히 유사한 방식입니다. 예를 들어, 저희가 처음 C언어를 배울 때는 많은 양의 지식을 배우고 많은 시간을 들여야지만 이해할 수 있었습니다. 그러나 C언어에 익숙해지고 다른 프로그래밍 언어를 배울 때는, C언어를 배울 때보다 적은 공부량으로도 더 빠르게 학습할 수 있었을 거예요. 이는 축적되어 온 지식을 활용하여 이해하기 때문일 것입니다. 딥러닝에서도 마찬가지로, 아주 많은 양의 정보로 모델을 미리 학습시켜 놓는다면 그 모델을 활용하여 적은 양의 데이터로도 다른 문제를 손쉽게 풀 수 있도록 할 수 있지 않을까요? 많은 양의 정보로 학습한 모델을 사전 학습 모델, pre-trained 모델이라고 합니다. 그리고 익히 들어보셨을 fine tuning은 전이학습의 한 방법입니다.</Typography>
                                <Typography className={classes.articleBody} variant='body1'>자연어처리 분야에서는 처음 등장한 사전학습모델은 <Link href={'http://jalammar.github.io/illustrated-bert/'} target={'_blank'}>BERT</Link>입니다. BERT는 위키피디아의 대용량 데이터로 대형 모델을 긴 시간동안 학습시킨 모델입니다. 문장을 분류하는데 이 모델을 사용하고 싶다면, 모델의 출력단에 Fully connected layer 하나만 붙여놓고 소량의 데이터로 몇 번 더 학습시키면 끝납니다. 정확도가 한순간에 90% 이상으로 올라갔어요. BERT 등장 이후 연구자들이 더이상 뭘 연구해야 될지 모르겠다고 한탄하기도 했답니다. 이렇듯 딥러닝은 Transfer learning의 형태로 발전하고 있습니다. 앞으로도 계속 이러한 방향으로 발전할듯 하니, 어떤 개념인지 잘 공부하시면 좋겠습니다.</Typography>
                                <Typography className={classes.articleSectionTitle} variant='subtitle1'>Traning objective의 변화</Typography>
                                <Typography className={classes.articleBody} variant='body1'>위에서 전이학습을 설명하면서, 전이학습을 위해서는 대용량의 데이터로 미리 학습한 사전학습모델이 있어야 한다고 말씀드렸습니다. 사전 학습은 데이터 자체가 스스로 정답이 되는 self-supervised learning입니다. 즉, 사람이 답을 만들어 줄 필요없이 데이터만 모델에 입력하면 모델 스스로 데이터에 대해 학습한다는 말입니다. 단, 모델이 <strong>스스로 학습할 수 있도록</strong> 문제를 만들어 줘야 하는데 이 문제를 training objective라고 합니다.</Typography>
                        ...
                        <Collapse in={isOpen[10]}>
                            <Typography className={classes.articleBody} variant="body1">다른 CS 분야와는 다르게 ML/DL 분야는 빠르게 변화하고 있고, 한편의 논문이 큰 파장을 불러일으키는 경우가 많습니다. 그리고 ML/DL 기술을 연구하고 적용하는 방법이 정형화 되어 있지 않기 때문에 늘 연구자들이 어떤 방향성을 가지고 있는지 늘 파악해야 합니다.  그래서 이 분야에서 계속 연구하고, 일하고 싶다면 <strong>논문을 읽는 것을 생활화</strong> 해야 합니다. </Typography>
                            <Typography className={classes.articleBody} variant='body1'>먼저, 앞서 언급한 자연어처리의 흐름을 따라가며 공부할 때 같이 읽으면 좋을 논문들부터 소개합니다. 이 다섯개의 논문들 중에서도 <strong>반드시 읽어야 할 단 하나의 논문</strong>을 꼽으라고 한다면, 저는 <strong>Attention Is All You Need</strong>를 고르겠습니다. 이 논문은 Transformer를 소개한 논문입니다. 앞서도 말씀드렸지만, Transformer가 공개된 후로 자연어처리 분야는 완전히 새로운 길로 나아가게 됩니다. 현재는 자연어처리 분야뿐만 아니라 비전 등 다른 분야에서도 활발히 이용되고 있습니다. 그렇기 때문에 어렵더라도 반드시 읽고 이해해주세요.</Typography>
                            ...
                            <Typography className={classes.articleBody} variant="body1">자연어처리 분야의 트렌드는 <strong>Major 국제 컨퍼런스</strong>에 제출되는 논문들을 살펴보며 파악할 수 있습니다. 이는 자연어처리 분야 뿐만 아니라 다른 딥러닝 분야도 마찬가지입니다. AI, 딥러닝, 자연어처리 분야에서 가장 유명한 컨퍼런스의 웹사이트를 정리해보았습니다. <strong>Accepted Papers</strong> 리스트에서 내가 관심있는 주제로 검색을 하시고, <strong>Best Paper Awards</strong> 를 받은 논문도 살펴보세요. 아직 2021 컨퍼런스가 진행되지 않아서, 2020년도부터 살펴보시면 됩니다. 구글에서 관심있는 컨퍼런스 + trend, hot topic, review 등으로 검색하면 사람들이 컨퍼런스를 보고 정리해놓은 자료도 찾을 수 있습니다. 너무 방대한 양이 부담스러우시다면 그런 자료로 먼저 시작하는 것도 좋을 것 같습니다.</Typography>
                            <List>
                            ...
                            <Typography className={classes.articleBody} variant='body1'>내가 하는 프로젝트에서 필요한 정보 등, 좀 더 구체적인 논문을 찾고 싶다면 Google Scholar [https://scholar.google.com/](https://scholar.google.com/) 에서 검색해보세요. 제가 검색했던 예시들입니다.</Typography>
                            <List>
                            ...
                            <Typography className={classes.articleBody} variant='body1'>이런 식으로 내가 <strong>찾고 싶은 내용</strong>과 반드시 들어가야 하는 <strong>키워드를 조합</strong>하여 검색하고, 검색 결과에서 피인용수가 높은 논문들부터 읽었습니다. 대부분의 논문들은 공개 되어 있으나, 가끔씩 유료로 읽어야 되는 논문들도 있었는데 이럴 때는 <strong>로욜라 도서관 홈페이지</strong>를 이용했습니다. 읽고 싶은 논문 제목을 복사하여 로욜라에서 검색하면 무료로 열람하고 다운로드 받을 수 있습니다.</Typography>
                        </Collapse>
                        ...
                        <Collapse in={isOpen[5]}>
                            <Typography className={classes.articleBody} variant="body1"></Typography>
                            <img className={classes.img} src={"https://sogang-tree-dev.s3.ap-northeast-2.amazonaws.com/images/NLP_intro.png"} alt="NLP"></img>
                            <Typography className={classes.articleBody} variant="body1"></Typography>
                            <Typography className={classes.articleBody} variant="body1"></Typography>
                            <img className={classes.img} src={"https://sogang-tree-dev.s3.ap-northeast-2.amazonaws.com/images/NLP_intro.png"} alt="NLP"></img>
                ...
                <Collapse in={isOpen[3]}>
                    <Container>
                        ...
                        <Typography style={{float: 'none'}} variant="h6" onClick={() => handleClick(18)}>{isOpen[18] ? <ArrowDropDown/> : <ArrowRight/>}Syllabus</Typography>
                        ...
                        <Typography className={classes.articleBody} variant="body1">이 중에서 제가 추천하는 데이터는 <StrongText>네이버 영화 리뷰 데이터</StrongText>입니다. Github에 찾아보시면 이 데이터를 사용한 레포지토리가 매우 많아서 참고하기 좋습니다. 또한 새로운 한국어 훈련 모델이 나올때마다 NSMC 데이터로 성능 비교를 하므로 내가 한 프로젝트가 어느 정도 성능을 보이는지 객관적인 평가가 가능합니다. 이때 반드시 <StrongText>Github에 commit을 하며 프로젝트를 진행</StrongText>해야 합니다. Github 사용법은 아래에 정리했으니 참고하세요.</Typography>
                        <Typography className={classes.articleBody} variant="body1">쉬운 프로젝트로 감을 익힌 후에는 내가 관심 있는 세부 분야를 찾아야 합니다. 그리고 해당 분야의 문제점은 무엇인지, 연구자들이 이를 해결하기 위하여 어떤 노력을 하고 있는지 <StrongText>논문</StrongText>을 살펴보아야 합니다. 최신 논문, 피인용 수가 많은 논문, 최우수 논문 등 여러가지 기준을 놓고 논문을 찾으세요. 그리고 논문에서 말하는 바를 스스로 구현해보세요. 꼭 논문이 아니더라도 구글에 검색하여 나오는 정보를 적용하는 것도 중요합니다.</Typography>
                        ...
                        <Collapse in={isOpen[11]}>
                            ...
                            <List>
                                <ListItem><Link href={'https://www.huskyhoochu.com/issue-based-version-control-201/'}>github 하나로 1인 개발 워크플로우 완성하기: 실전 편</Link></ListItem>
                                <ListItem><Link href={'https://gmlwjd9405.github.io/2018/05/11/types-of-git-branch.html'}>[GitHub] Git 브랜치의 종류 및 사용법 (5가지)</Link></ListItem>
                                <ListItem><Link href={'https://gmlwjd9405.github.io/2018/05/12/how-to-collaborate-on-GitHub-3.html'}>[GitHub] GitHub로 협업하는 방법[3] - Gitflow Workflow</Link></ListItem>
                                <ListItem><Link href={'https://blog.ull.im/engineering/2019/03/10/logs-on-git.html'}>좋은 git commit 메시지를 위한 영어 사전</Link></ListItem>
                            </List>
                        ...
                        <Collapse in={isOpen[12]}>
                            <Typography className={classes.articleBody} variant="body1">딥러닝을 위한 프레임워크로는 <strong>Tensorflow</strong>와 <strong>Pytorch</strong>가 있습니다. 두 프레임워크는 통상적으로 실제 서비스에 서빙을 할 것인지, 연구를 할 것인지에 따라 선택합니다. Tensorflow는 서빙에, Pytorch는 연구에 장점이 있습니다. 그 이유를 간단히 설명드리겠습니다. Tensorflow는 static graph를 구축하고 Pytorch는 dynamic graph를 구축합니다. Tensorflow는 모델을 빌드할 때 해당 모델의 computational graph를 완전히 빌드하여 이를 계속 사용합니다. 그렇기 때문에 original python code에 대한 접근 없이도 구동할 수 있고, C++환경 위에서 손쉽게 import하여 사용할 수 있습니다. 반면 Pytorch는 매 iteration마다 새로운 computatinal graph를 생성합니다. 그리고 계산 시에는 C++단에서 계산하고 계산의 결과는 python code단으로 보내 처리합니다. 그렇기 때문에 iteration 중간에 모델 구조를 변경하는 등 유연하게 처리가 가능합니다. 저는 학부연구생일 때 Pytorch를 공부하였는데 입사하고 나서 Tensorflow를 다시 배우고 있습니다😭</Typography>
                            <Typography className={classes.articleBody} variant="body1">Pytorch를 익힐 때 먼저 <Link href={'https://pytorch.org/'} target={'_blank'}><strong>공식 tutorial</strong></Link>부터 따라해보세요. 그리고 저는 <Link href={'https://github.com/bentrevett/pytorch-seq2seq'} target={'_blank'}>github 레포지토리</Link>에서 transformer seq2seq 구조를 익혔습니다. Jupyter Notebook으로 정리가 매우 잘 되어 있어서 하나씩 따라해보기 좋습니다. seq2seq 레포지토리뿐만 아니라 sentiment analysis 등의 다른 주제도 있으니 내가 관심있는 것을 선택하세요. 코드 한줄 한줄마다 어떤 결과값이 나오는지, Tensor shape은 어떻게 변경 되는지 꼭 확인하면서 따라가세요. 딥러닝의 코드 구현은 데이터를 잘 짜맞춰서 레이어를 통과시키는 문제이기 때문에 <strong>데이터의 shape을 파악</strong>하는 것이 중요합니다. <strong>코드는 레고 블럭</strong>이라고 생각하세요. 원하는 모양대로 쌓아올리면 그만입니다. 내가 쌓은 블럭에 어떤 데이터가 들어가서 어떤 값이 나오는지가 중요합니다.</Typography>
                            <Typography className={classes.articleBody} variant="body1">Pre-trained 모델을 사용할 시기가 오면, <strong>huggingface transformers</strong> 라이브러리를 살펴보셔야 합니다. <Link href={'https://huggingface.co/transformers/index.html'} target={'_blank'}>공식 다큐멘트</Link>가 매우 잘 정리되어 있으므로 즐겨찾기 해놓고 읽으시면 좋습니다. 이때도 <strong>Parameters</strong>와 <strong>Returns</strong>값으로 어떤 형태의 데이터가 오고 가는지 파악하는게 중요합니다. 여유가 있다면, 소스 코드로 들어가서 어떻게 구현이 되어있는지 타고 올라가며 이해해보세요.</Typography>
                            <Typography className={classes.articleBody} variant="body1">Pytorch는 학습 시 custom training loop을 이용합니다. Tensorflow keras에서 model.fit으로 학습을 해결하는 것과는 조금 다릅니다. BERT 등 모델의 학습 코드 예시를 다음 링크에서 확인해보세요. <Link href={'https://github.com/huggingface/transformers/blob/master/examples/text-classification/run_glue.py'} target={'_blank'}>Pytorch 공식 Github의 example/text-classification/run_glue.py</Link>입니다. 그리고 저는 프로젝트에서 KcBERT를 주로 이용하는데, <Link href={'https://github.com/Beomi/KcBERT-Finetune/blob/master/run_seq_cls.py'} target={'_blank'}>저자의 finetuning 코드</Link>를 많이 참조했습니다.</Typography>
                        </Collapse>
                    </Container>
                </Collapse>
                ...
                <Collapse in={isOpen[4]}>
                    <Container>
                        <Typography className={classes.articleBody} variant="body1">저는 수학과의 선형대수학 강의로 처음 공부했습니다. 그런데 시간이 부족해서 뒷부분에 특이값 분해 등의 내용을 배우지 못해서 따로 더 공부했습니다. 학교에서 Gilbert Strang 교수님의 Introduction to Linear Algebra 교재로 공부했고, 따로 공부할 때도 해당 강의를 먼저 들었습니다. 강의는 <Link href={'https://ocw.mit.edu/courses/mathematics/18-06-linear-algebra-spring-2010/video-lectures/'} target={'_blank'}>여기</Link>에서 확인할 수 있습니다.</Typography>
                        <Typography className={classes.articleBody} variant="body1">David C. Lay 교수님의 <Link href={'https://math.berkeley.edu/~yonah/files/Linear%20Algebra.pdf'}>Linear Algebra and its applications 교재</Link>는 위의 교재보다 좀 더 응용 문제가 많아서 문제를 풀어보기에 좋습니다. 그리고 동치인 statement들(예를 들어 invertible matrix에 대해)을 모아서 제시해줘서 더 직관적으로 생각할 수 있었습니다. 위 강의를 들으며 개념을 익히고 이 교재에 있는 문제를 푸는 식으로 공부해보세요.</Typography>
                ...
                <Collapse in={isOpen[17]}>
                    <Container>
                        ...
                        <Typography className={classes.articleBody} variant="body1">기초C언어, 데이터베이스입문, 기초JAVA언어, <strong>기초빅데이터프로그래밍, 자료구조입문, 알고리즘입문</strong></Typography>
                        <Typography variant="subtitle1">수학, 통계</Typography>
                        <Typography className={classes.articleBody} variant="body1">경영통계학, <strong>선형대수학, 계량경제학</strong>,  고등미적분학, <strong>응용경영통계</strong></Typography>
                    </Container>
                </Collapse>

                <Typography className={classes.articleSectionTitle} variant="h5" >맺으며</Typography>
                <Container>
                    <Typography className={classes.articleBody} variant="body1">저는 2019년 9월부터 학부연구생을 시작하면서 파이썬을 공부했고, 2020년 1월부터 딥러닝을 시작했습니다. 그때가 4학년 1학기였어요. 지금 이 글을 보시는 분들 중에 고학년에 올라와서 이쪽 분야에 관심을 가진 분들도 계실 거예요. 너무 늦은건 아닐까 불안한 마음을 가지고 있을 거라 생각합니다. 저도 똑같은 마음이었습니다. 그런데 그 때 친구가 해줬던 말이 있어요. <StrongText>"해보지 않고서 불안해 하지 말고 일단 시작부터 해."</StrongText> 저는 이 말을 들은 다음날 연구실에 컨택해서 연구생 생활을 시작했습니다. 해보지 않으면 몰라요. 그러니 꼭 도전해보시길 바랍니다.</Typography>
                ...
                <Typography align={'right'} variant="subtitle1">Written By. 천재윤</Typography>
            </Container>
        </div>
    )
}
